...
This kernel targets the fixed-length full-sequence training/prefill case.  The
autograd wrapper in ``mamba3_siso_combined.py`` uses it for forward and reuses
the existing Simamba backward recomputation path for gradients.
"""
